...
- Analyze pricing differences across airlines and travel classes

- Understand how booking time affects ticket cost
...
- Prices increase sharply as the departure date approaches

- Premium airlines consistently charge higher fares
...
- Price trends based on booking time (days left)

- Airline-wise and class-wise price comparison

- Stops vs price and departure time vs price analysis
...
- Class Impact: Business class fares are multiple times higher than Economy

- Stops: Flights with stops are cheaper than non-stop flights

- Airlines: Premium airlines consistently charge higher prices
